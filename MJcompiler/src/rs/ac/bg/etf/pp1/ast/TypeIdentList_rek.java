...
public class TypeIdentList_rek extends TypeIdentList {
    ...
    public TypeIdentList_rek (Type Type, String I2, ZeroOneSqBracket ZeroOneSqBracket, TypeIdentList TypeIdentList) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("TypeIdentList_rek(\n");
