...
public class ConstDeclMore_rek extends ConstDeclMore {

    private ConstDecl ConstDecl;
    private ConstDeclMore ConstDeclMore;

    public ConstDeclMore_rek (ConstDecl ConstDecl, ConstDeclMore ConstDeclMore) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstDeclMore_rek(\n");
