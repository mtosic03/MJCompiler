...
public class Factor_first extends Factor {

    private Designator Designator;
    private ActParsBracketsZeroOne ActParsBracketsZeroOne;

    public Factor_first (Designator Designator, ActParsBracketsZeroOne ActParsBracketsZeroOne) {
