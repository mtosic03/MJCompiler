...
public class CaseList_first extends CaseList {
    ...
    public CaseList_first (Integer N1, CaseMarker CaseMarker, StatementList StatementList, CaseList CaseList) {
        this.N1=N1;
