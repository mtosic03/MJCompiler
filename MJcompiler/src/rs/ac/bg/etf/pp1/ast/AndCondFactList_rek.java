...
public class AndCondFactList_rek extends AndCondFactList {

    private AndCondFactList AndCondFactList;
    private CondFact CondFact;

    public AndCondFactList_rek (AndCondFactList AndCondFactList, CondFact CondFact) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AndCondFactList_rek(\n");
