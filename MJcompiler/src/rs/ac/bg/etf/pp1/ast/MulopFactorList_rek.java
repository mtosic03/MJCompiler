...
public class MulopFactorList_rek extends MulopFactorList {

    private MulopFactorList MulopFactorList;
    private Mulop Mulop;
    private Factor Factor;

    public MulopFactorList_rek (MulopFactorList MulopFactorList, Mulop Mulop, Factor Factor) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MulopFactorList_rek(\n");
