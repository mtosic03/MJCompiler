...
public class AddopTermList_rek extends AddopTermList {

    private AddopTermList AddopTermList;
    private Addop Addop;
    private Term Term;

    public AddopTermList_rek (AddopTermList AddopTermList, Addop Addop, Term Term) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AddopTermList_rek(\n");
